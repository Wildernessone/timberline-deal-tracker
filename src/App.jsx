...
const BRAND_DOMAINS = {
  ...
  "Schnees":"schnees.com","Benchmade":"benchmade.com","Phelps Game Calls":"phelpsgamecalls.com","Filson":"filson.com","SKRE Gear":"skregear.com","Lone Wolf Custom Gear":"lonewolfcustomgear.com","Trophyline":"trophyline.com","Higdon Outdoors":"higdonoutdoors.com","Tanglefree":"tanglefree.com","Rig Em Right":"rigemright.com","MotionDucks":"motionducks.com","Buck Gardner":"buckgardner.com","Duck Creek Decoys":"duckcreekdecoys.com","Chenegear":"chenegear.com","Quickcoys":"quickcoys.com",
};
...
const PORTALS = {
  ...
  whitetail: {
    ...
    brands:["Sitka","First Lite","Keen","Katabatic Gear","Zpacks","Mtn Ops","Crispi","Yeti","Outdoor Research","Kings Camo","Marsupial Gear","Blue Coolers","Hoyt","Maven","Mathews","Forloh","Kryptek","Montana Knife Company","Kenetrek","Primos","Canvas Cutter","Outdoor Edge","Badlands","Wilderness Athlete","Pnuma Outdoors","Thermarest","Helinox","Duckworth","Chota Outdoor","Goat Knives","Darn Tough","FHF Gear","On Glass","GoHunt","Mystery Ranch","Vortex","Leupold","Swarovski","Garmin","onX","Sig Sauer","Schnees","SKRE Gear","TideWe","Mossy Oak","Bone Collector","Nomad Outdoor","XOP Outdoors","Novix Outdoors","Hunting Beast Gear","Lone Wolf Custom Gear","Trophyline","Filson","Drake Waterfowl","Buck Gardner"],
  ...
  waterfowl: {
    ...
    brands:["Drake Waterfowl","Sitka","Yeti","Garmin","onX","Vortex","Leupold","Sig Sauer","Chota Outdoor","Helinox","Mtn Ops","Benchmade","Outdoor Edge","Wilderness Athlete","Darn Tough","Higdon Outdoors","Tanglefree","Rig Em Right","MotionDucks","Buck Gardner","Duck Creek Decoys","Chenegear","Quickcoys","Mossy Oak","Filson"],
...
function PriceSearch({T,P,wishlist,setWishlist,deals,family,onOpenDeal,user,onWatch,isWatched}) {
  ...
  useEffect(() => {
    // Intentional: clear the price-history cache when the search empties out.
...
function AdminDashboard({T, user}) {
  ...
  // Render-time clock for "days ago" math; this component sits after early returns so a hook can't be added here.
...
export function EmbedCard({dealId}) {
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Intentional: resolve the URL's /brand/<slug> to a real brand once deals (and thus liveBrands) have loaded.
    // eslint-disable-next-line react-hooks/set-state-in-effect
