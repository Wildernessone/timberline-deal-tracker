...
const DEALS = [
  {
    id:1,brand:"Sitka",product:"Celsius MX Down Jacket",portal:"timberline",
    orig:549,sale:329,cat:"Insulation",fake:false,coupon:null,
    url:"https://www.sitkagear.com",
    sizes:{mens:["M","L","XL"],womens:[],youth:["YL"]},
    tags:[],history:[549,549,499,549,549,329],
    blurb:"800-fill down, waterproof shell. Sitka's warmest insulation layer.",
  },
  {
    id:2,brand:"First Lite",product:"Kanab Hoody",portal:"timberline",
    orig:189,sale:119,cat:"Base Layer",fake:false,coupon:"FIRSTHUNT15",
    url:"https://www.firstlite.com",
    sizes:{mens:["S","M","L"],womens:["S","M"],youth:[]},
    tags:[],history:[189,189,189,199,119,119],
    blurb:"Midweight merino, naturally odor resistant. Perfect for multi-day hunts.",
  },
  {
    id:3,brand:"Kuiu",product:"Guide DCS Pant",portal:"timberline",
    orig:229,sale:199,cat:"Pants",fake:true,coupon:null,
    fakeNote:"Price raised $30 three weeks before this sale -- original was $199",
    url:"https://www.kuiu.com",
    sizes:{mens:["30x32","32x32","34x32"],womens:[],youth:[]},
    tags:[],history:[199,199,199,229,229,199],
    blurb:"4-way stretch softshell. Good pant -- but this is not a real sale.",
  },
  {
    id:4,brand:"Stone Glacier",product:"Skre Windshell",portal:"timberline",
    orig:279,sale:195,cat:"Wind Layer",fake:false,coupon:"SG20OFF",
    url:"https://www.stoneglacier.com",
    sizes:{mens:["M","L","XL","XXL"],womens:["XS","S","M"],youth:["YM","YL"]},
    tags:[],history:[279,279,279,279,279,195],
    blurb:"2.5oz ultralight wind layer. Packs into its own pocket. Legit 30% off.",
  },
  {
    id:5,brand:"Sitka",product:"Jetstream Vest",portal:"timberline",
    orig:299,sale:224,cat:"Insulation",fake:false,coupon:null,
    url:"https://www.sitkagear.com",
    sizes:{mens:["S","M","L"],womens:["XS","S"],youth:[]},
    tags:[],history:[299,299,280,299,299,224],
    blurb:"Stretch fleece and 800-fill down hybrid. All-day active insulation.",
  },
  {
    id:6,brand:"Kings Camo",product:"XKG Summit Bibs",portal:"timberline",
    orig:349,sale:249,cat:"Bibs",fake:false,coupon:"KINGS10",
    url:"https://www.kingscamo.com",
    sizes:{mens:["M","L","XL"],womens:[],youth:["YS","YM","YL"]},
    tags:[],history:[349,349,349,349,349,249],
    blurb:"Waterproof, breathable bibs. Great intro gear for youth hunters.",
  },
  {
    id:7,brand:"Drake",product:"MST Fleece-Lined Wader Pants",portal:"blind",
    orig:179,sale:129,cat:"Waders",fake:false,coupon:null,
    url:"https://www.drakewtc.com",
    sizes:{mens:["M","L","XL","2XL"],womens:[],youth:[]},
    tags:[],history:[179,179,179,179,179,129],
    blurb:"Fleece-lined, waterproof wader pants built for cold water. Drake nailed it.",
  },
  {
    id:8,brand:"Banded",product:"RedZone Breathable Waders",portal:"blind",
    orig:349,sale:249,cat:"Waders",fake:false,coupon:"BANDED20",
    url:"https://www.bandedgear.com",
    sizes:{mens:["S","M","L","XL","2XL"],womens:[],youth:[]},
    tags:[],history:[349,349,299,349,349,249],
    blurb:"5mm neoprene alternative with full breathability. Legit 29% off.",
  },
  {
    id:9,brand:"Mossy Oak",product:"Sherpa 2.0 Insulated Jacket",portal:"treestand",
    orig:149,sale:89,cat:"Clothing",fake:false,coupon:null,
    url:"https://www.mossyoak.com",
    sizes:{mens:["M","L","XL","2XL"],womens:["S","M","L"],youth:["YM","YL"]},
    tags:[],history:[149,149,149,149,149,89],
    blurb:"Sherpa-lined insulation in classic Bottomland. 40% off, no tricks.",
  },
  {
    id:10,brand:"Stealth Cam",product:"Fusion X Cellular Camera",portal:"treestand",
    orig:179,sale:139,cat:"Trail Cams",fake:false,coupon:"SCAM20",
    url:"https://www.stealthcam.com",
    sizes:{mens:[],womens:[],youth:[]},
    tags:[],history:[179,179,179,169,179,139],
    blurb:"4G LTE, 26MP, no-glow IR. Solid cellular cam at a real discount.",
  },
];

const COUPONS = [
  {brand:"First Lite",code:"FIRSTHUNT15",discount:"15% off everything",expires:"May 31",verified:true,url:"https://www.firstlite.com",portal:"timberline"},
  {brand:"Stone Glacier",code:"SG20OFF",discount:"20% off sale items",expires:"Jun 15",verified:true,url:"https://www.stoneglacier.com",portal:"timberline"},
  {brand:"Kings Camo",code:"KINGS10",discount:"10% sitewide",expires:"Jun 1",verified:true,url:"https://www.kingscamo.com",portal:"timberline"},
  {brand:"Kuiu",code:"KFALL25",discount:"25% off jackets",expires:"May 25",verified:false,url:"https://www.kuiu.com",portal:"timberline"},
  {brand:"Drake",code:"DRAKE15",discount:"15% off waders",expires:"Jun 30",verified:true,url:"https://www.drakewtc.com",portal:"blind"},
  {brand:"Banded",code:"BANDED20",discount:"20% off all gear",expires:"Jun 15",verified:true,url:"https://www.bandedgear.com",portal:"blind"},
  {brand:"Stealth Cam",code:"SCAM20",discount:"$20 off any cellular cam",expires:"Jun 1",verified:true,url:"https://www.stealthcam.com",portal:"treestand"},
  {brand:"Mossy Oak",code:"MO30",discount:"30% off apparel",expires:"May 31",verified:true,url:"https://www.mossyoak.com",portal:"treestand"},
];
